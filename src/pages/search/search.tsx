...
const Search = () => {
    ...
    useEffect(() => {
        dispatch(searchEvents(searchQuery as string));        
      }, [dispatch]);
                    ...
                    <h1>
                        {
                            searchQuery && (
                                searchQuery.length > 15 ? (
                                    translate(lang, ("نتائج: " + searchQuery.substring(0, 15) + '...') as string, searchQuery.substring(0, 15) + '...' + " results")
                                ) :
                                (
                                    translate(lang, ("نتائج: " + searchQuery) as string, searchQuery + " results")
                                )
                            )
                        }
                        {
